...
import fragmentShader from '../../../shaders/experiments/halftone.frag.glsl?raw';
import { getPrevExperiment, getNextExperiment, getExperimentById } from '../experimentConfig';
import { ThemeContext } from '../../../context/ThemeContext';

/**
 * V11: Halftone / Dithering Experiment
 *
 * Visual Effect:
 * - 3D Raymarched shape (Twisted Torus)
 * - Screen-space Halftone Pattern
 * - Red dots on cream background (Reference style)
 *
 * Technical Details:
 * - Raymarching for geometry
 * - Dot matrix logic based on lighting intensity
 */

const CURRENT_ID = 'v11';
    ...
    return (
        <>
            <BaseExperimentShader
                ...
                title={`${CURRENT_ID.toUpperCase()}: ${current?.name || 'Halftone'}`}
            />
            <NavOverlay>
...
export default HalftoneExperiment;
