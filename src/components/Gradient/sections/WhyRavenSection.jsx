...
export default function WhyRavenSection() {
  ...
  return (
    ...
    >
      ...
      >
        <DotMatrixImage
          src={ravenCloseupImg}
          alt="Raven glasses close-up with branding"
          className="w-full"
          animated={true}
          config={{
            gridSize: 6,
      ...
      <div className="w-full max-w-7xl mx-auto px-8 md:px-12 lg:px-16 relative z-10">
        <div className="flex justify-start">
          ...
          >
            ...
            <p
              className="animate-in text-lg md:text-xl mb-5"
              style={{
                color: '#2E2E2E',
            ...
            <p
              className="animate-in text-xl md:text-2xl"
              style={{
                fontFamily: "'Playfair Display', Georgia, serif",
                fontStyle: 'italic',
                color: '#6E6E6E'
